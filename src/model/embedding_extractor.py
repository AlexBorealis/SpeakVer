...
class EmbeddingExtractor(nn.Module):
    def __init__(
        ...
        self.classifier = EncoderClassifier.from_hparams(
            source=source, savedir=savedir, run_opts={"device": str(self.device)}
        )
    ...
    def freeze_layers(self, trainable_layers):
        layers = list(self.mods.embedding_model.children())
    ...
    def extract(self, waveform):
        ...
        return self.forward(waveform).squeeze(0).cpu()
