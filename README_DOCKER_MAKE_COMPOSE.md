...
После запуска приложение будет доступно по адресу [localhost](http://127.0.0.1:7860)
...
По умолчанию контейнер публикует сервис только на [localhost](http://127.0.0.1:7860)
